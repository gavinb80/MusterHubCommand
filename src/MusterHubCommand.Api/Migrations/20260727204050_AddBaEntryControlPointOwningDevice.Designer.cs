...
namespace MusterHubCommand.Api.Migrations
{
    ...
    [Migration("20260727204050_AddBaEntryControlPointOwningDevice")]
    partial class AddBaEntryControlPointOwningDevice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusterHubCommand.Api.Data.Entities.IncidentObjective", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AchievedByName")
                        .HasColumnType("text");
                    ...
                    b.ToTable("IncidentObjectives");
                });

            modelBuilder.Entity("MusterHubCommand.Api.Data.Entities.IncidentRisk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MusterHubCommand.Api.Data.Entities.IncidentObjective", b =>
                {
                    ...
                    b.HasOne("MusterHubCommand.Api.Data.Entities.Employee", "RaisedByEmployee")
                        .WithMany()
